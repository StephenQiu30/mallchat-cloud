-- E2E Test Schema - subset of mallchat.sql for chat-service integration tests
-- Only includes tables needed for the private message E2E flow
...
(
    ...
    `extra`         json              DEFAULT NULL COMMENT '消息扩展内容',
...
-- 通知表 (needed for friend apply notifications)
