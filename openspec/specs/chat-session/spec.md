...
Define the MVP session-list behavior for chat, including session ordering, unread maintenance, display metadata, and user-local session management actions.
